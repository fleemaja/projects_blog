    ...
    <html lang="en">
      <body className="flex flex-col-reverse md:flex-row">
        <aside className="sticky bottom-0 md:h-screen top-0 bg-slate-200">
            <div className="flex flex-row md:flex-col items-center justify-center gap-2 sm:gap-10 md:p-5 text-sm font-bold text-gray-600">
              ...
              <Link href={`/curiosities`} className="flex flex-col items-center justify-center text-center hover:underline hover:bg-slate-300 rounded-lg p-5">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="h-10 w-10">
